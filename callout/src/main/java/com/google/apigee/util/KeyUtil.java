...
public class KeyUtil {
  ...
  public static PrivateKey decodePrivateKey(String privateKeyPemString, String password)
      throws IOException, PKCSException, PEMException, OperatorCreationException {
    ...
    try {
      ...
      if (o instanceof PEMKeyPair) {
        ...
        return (PrivateKey) converter.getPrivateKey(((PEMKeyPair) o).getPrivateKeyInfo());
      }

      if (o instanceof PrivateKeyInfo) {
        // eg, "openssl genpkey  -algorithm rsa -pkeyopt rsa_keygen_bits:2048 -out keypair.pem"
        return (PrivateKey) converter.getPrivateKey((PrivateKeyInfo) o);
      }
